...
![](https://img-blog.csdnimg.cn/11a8dfbb395d4802bf900fc38e115359.png?x-oss-process=image/watermark,type_ZHJvaWRzYW5zZmFsbGJhY2s,shadow_50,text_Q1NETiBAQWxleCBIdWI=,size_13,color_FFFFFF,t_70,g_se,x_16#pic_center)
点击下面的框，创建一个基本任务
![](https://img-blog.csdnimg.cn/a8b17d9ac08842dc8bcf39a70b18f6b1.png?x-oss-process=image/watermark,type_ZHJvaWRzYW5zZmFsbGJhY2s,shadow_50,text_Q1NETiBAQWxleCBIdWI=,size_20,color_FFFFFF,t_70,g_se,x_16#pic_center)
...
以我的模板(hexo-theme-matery)为例：
1. 要在每篇有数学公式文章的Front-matter中加上```mathjax: true```

![](https://cdn.jsdelivr.net/gh/gaofeng-lin/picture_bed/img/Snipaste_2023-03-15_15-36-17.png)


2. 把模板_config.yml中的mathjax配置项的值置为true，全局搜索就可以找到。

如果上述方法都不行，考虑下下面的办法，每尝试一个办法，可以马上验证下是否可行。
...
修改文件 node_modules\kramed\lib\rules\inline.js
