...
跟他比的时候自己按他的方法复现一个，怎么粗糙怎么来，简直就是最好的靶子。碰到个效果开源都做的很好的论文，怎么打都打不过，这才是绝望。

问：问题是你复现出来稀巴烂 但他论文指标很高 你用复现的指标 reviewer直接diss你压低baseline

答：我一般自己github 上放上复现的代码，写明unofficial implementation，然后跟reviewer说他们没代码，我只能按这个复现。从来没问题

**还有一个办法是用自己的数据集，谁都没跑过的那种数据集，你数据比他高也说得过去**