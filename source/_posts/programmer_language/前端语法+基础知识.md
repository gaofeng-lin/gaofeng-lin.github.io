...
![点击一次](https://s2.loli.net/2022/07/25/HXBQeZVgbMu8pY9.png)
...
![](https://cdn.jsdelivr.net/gh/gaofeng-lin/picture_bed/img/2b6243000b0d48f69f6baf1e77293818.png)
**解释**
...
![](https://cdn.jsdelivr.net/gh/gaofeng-lin/picture_bed/img/7803115884ae4f6ab5f8d4cd73cfe038.png)
...
```
对于promise的理解
1. resolve、reject会选择一个执行，这两个是调用这个对象的时候传过来的**函数**
...
#### 工作原理
![](https://cdn.jsdelivr.net/gh/gaofeng-lin/picture_bed/img/a83d7857217f3e6d72b8fab68fb3adb9.gif)
...
![](https://cdn.jsdelivr.net/gh/gaofeng-lin/picture_bed/img/htmlrender.jpg)
...
![](https://cdn.jsdelivr.net/gh/gaofeng-lin/picture_bed/img/userrender.jpg)
...
![](https://cdn.jsdelivr.net/gh/gaofeng-lin/picture_bed/img/5e82d6a40942890d12001242.jpg)
...
![](https://cdn.jsdelivr.net/gh/gaofeng-lin/picture_bed/img/20181207092232976.png)
值得说的是虽然浏览器禁止用户对请求返回数据的显示和操作，但浏览器确实是去请求了，如果服务器没有做限制的话会返回数据的，在调试模式的network中可以看到返回状态为200，且可看到返回数据
![](https://cdn.jsdelivr.net/gh/gaofeng-lin/picture_bed/img/20181207092757327.png)
![](https://cdn.jsdelivr.net/gh/gaofeng-lin/picture_bed/img/20181207092820725.png)
#### 2.阻止dom获取和操作
...
![](https://cdn.jsdelivr.net/gh/gaofeng-lin/picture_bed/img/8b0167fa9e5647359acc6466b8e421bd.png)
...
```
![](https://cdn.jsdelivr.net/gh/gaofeng-lin/picture_bed/img/681d3b6bcb6d4b039578fc23e6de073b.png)
...
![](https://cdn.jsdelivr.net/gh/gaofeng-lin/picture_bed/img/20210807230949959.png)
#### 代理服务器（一般用Nginx）
![](https://cdn.jsdelivr.net/gh/gaofeng-lin/picture_bed/img/20210807231812945.png)
